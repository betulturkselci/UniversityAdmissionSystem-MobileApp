...
class YazOkuluPage extends StatefulWidget {
  const YazOkuluPage({Key? key}) : super(key: key);

  @override
  _YazOkuluPageState createState() => _YazOkuluPageState();
}

class _YazOkuluPageState extends State<YazOkuluPage> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      labelText: 'Almak istediğiniz ders',
                      labelStyle: TextStyle(color: Colors.black),
                    ),
                    validator: (val) => val!.isEmpty ? 'dersi giriniz' : null,
                    onChanged: (val) {
                      setState(() => alinanDers = val);
                    },
                  ),
                ),
                SizedBox(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      final results = await FilePicker.platform.pickFiles(
                          ...
                          print('Pdf ekleme butonu:'+results.toString());
                      ...
                      Reference ref = FirebaseStorage.instance
                          .ref()
                          .child('yazokulubasvurular/' + fileName);
                ...
                Container(
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      dynamic result = await storage.setApplyData(
                          name,
                          ogrenciNo,
                          kimlikNo,
                          telNo,
